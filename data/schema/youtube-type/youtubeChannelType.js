...
const youtubeChannelType = module.exports = new GraphQLObjectType({
    ...
    fields: () => ({
        ...
        invideoPromotion: {
            type: new GraphQLList(channelPromotionType),
